...
namespace InSquare\SeoBundle\Tests\Builder;
...
class TagBuilderTest extends TestCase
{
    ...
    public function testRenderLinkWithCustomAttributes()
    {
        $this->tagBuilder->addLink(
            'alternate_pl',
            'https://example.com/page-pl',
            'alternate',
            null,
            null,
            ['hreflang' => 'pl']
        ...
        $this->assertEquals(
            '<link href="https://example.com/page-pl" rel="alternate" hreflang="pl" />',
            $this->tagBuilder->render()
        );
    }
